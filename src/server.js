...
const app=express(); const PORT=process.env.PORT||10000; const VERSION="6.7.0-vwap-multifactor-volume-rules"; app.use(express.json({limit:"1mb"})); app.use(express.static(path.join(__dirname,"../public"))); let lastUniverse=null,lastUniverseTime=0;
