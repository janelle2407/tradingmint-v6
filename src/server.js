...
const app=express(); const PORT=process.env.PORT||10000; const VERSION="6.9.0-full-session-trading"; app.use(express.json({limit:"1mb"})); app.use(express.static(path.join(__dirname,"../public"))); let lastUniverse=null,lastUniverseTime=0;
